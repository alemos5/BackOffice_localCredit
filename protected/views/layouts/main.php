        ...
        'items' => array(
            ...
            array(
                ...
                'items' => array(
                    ...
                    /*array('label' => '<img src="https://telocomproenusa.com/localCredit/images/idioma/idioma.png" alt="" width="20px">', 'url' => '#','items'=> array(
                        array('label' => '<img src="https://telocomproenusa.com/localCredit/images/idioma/english.png" alt="" width="20px"> English','icon'=>'file','url' => array('/usuario/Idioma/1')),
                        array('label' => '<img src="https://telocomproenusa.com/localCredit/images/idioma/espanol.png" alt="" width="20px"> Español','icon'=>'file','url' => array('/usuario/Idioma/2')),
...
<?php echo $content; ?>
    ...
    <?php if(!Yii::app()->user->isGuest):
		echo '<div class="back"  id="footer">				
				...
				<p><b>2018 - 2019 | &copy; LocalCredit | NIT: xxxxx</b></span></p>
		...
		echo '<div  id="footer">
				<hr class="soften">
				LocalCredit<br />
				<span><b>2018 - 2019 | &copy; LocalCredit | NIT: xxxxx</b></span>				
			  </div><!-- footer -->'; endif ?>
  </body>
</html>